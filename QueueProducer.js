...
var QueueProducer = function (solaceModule, queueName) {
    ...
    // main function
    producer.run = function (hosturl, vpn, username, password) {
        producer.connect(hosturl, vpn, username, password);
    };

    // Establishes connection to Solace message router
    producer.connect = function (hosturl, vpn, username, pass) {
        ...
        // create session
        try {
            producer.log('Solace message router VPN password: ' + pass);
