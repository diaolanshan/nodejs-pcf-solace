...
<small><sub>Version: 10.0.0 </sub></small>
				...
				<h1>
					<a href="solace.html" ><abbr title="solace">solace</abbr></a>.QueueType
				</h1>
			</div>
		</header>
	...
	<ul>
		...
		<li><a href="#static_properties">Static Properties & Enumerations</a></li>
			...
			<div class="description "><p><p>Specifies the type of remote resource to which an
<a href="solace.AbstractQueueDescriptor.html">solace.AbstractQueueDescriptor</a> refers.</p></p></div>
  ...
  <tbody>
    ...
    <tr class="public">
      ...
      <td class="last">
        <a href="#QUEUE">
        	<abbr title="solace.QueueType.QUEUE">
        		QUEUE
        	</abbr>
        </a>
    ...
    <tr class="public">
      ...
      <td class="last">
        <a href="#TOPIC_ENDPOINT">
        	<abbr title="solace.QueueType.TOPIC_ENDPOINT">
        		TOPIC_ENDPOINT
        	</abbr>
        </a>
        
        <span class="value">
         = <code>TOPIC_ENDPOINT</code>
        </span>
  ...
  <div class="location">
<!--
  	<a href="_opt_cvsdirs_loadbuild_jenkins_slave_apps-linux26-64-2_workspace_solclientjs_release_npm_org_solclientjs_sdk_core_node_modules_solclient-queue_lib_queue-types_js.html#lineno16">queue-types.js</a> at line 16
-->
  </div>
...
<div class="description "><p><p>The queue descriptor refers to a queue endpoint.</p></p></div>
...
<h3 id="TOPIC_ENDPOINT" class="public">
  
  <div class="location">
<!--
  	<a href="_opt_cvsdirs_loadbuild_jenkins_slave_apps-linux26-64-2_workspace_solclientjs_release_npm_org_solclientjs_sdk_core_node_modules_solclient-queue_lib_queue-types_js.html#lineno21">queue-types.js</a> at line 21
-->
  </div>
...
<div class="description "><p><p>The queue descriptor refers to a topic endpoint.</p></p></div>
