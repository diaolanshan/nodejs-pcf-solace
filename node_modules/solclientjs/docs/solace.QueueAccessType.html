...
<small><sub>Version: 10.0.0 </sub></small>
				...
				<h1>
					<a href="solace.html" ><abbr title="solace">solace</abbr></a>.QueueAccessType
				</h1>
			</div>
		</header>
	...
	<ul>
		...
		<li><a href="#static_properties">Static Properties & Enumerations</a></li>
			...
			<div class="description "><p><p>Represents the possible endpoint access types. The corresponding endpoint property is
<a href="solace.QueueProperties.html#accessType">solace.QueueProperties#accessType</a>.</p></p></div>
  ...
  <tbody>
    ...
    <tr class="public">
      ...
      <td class="last">
        <a href="#EXCLUSIVE">
        	<abbr title="solace.QueueAccessType.EXCLUSIVE">
        		EXCLUSIVE
        	</abbr>
        </a>
    ...
    <tr class="public">
      ...
      <td class="last">
        <a href="#NONEXCLUSIVE">
        	<abbr title="solace.QueueAccessType.NONEXCLUSIVE">
        		NONEXCLUSIVE
        	</abbr>
        </a>
      ...
      <td>
			...
			<h3 id="EXCLUSIVE" class="public">
  
  <div class="location">
<!--
  	<a href="_opt_cvsdirs_loadbuild_jenkins_slave_apps-linux26-64-2_workspace_solclientjs_release_npm_org_solclientjs_sdk_core_node_modules_solclient-queue_lib_queue-access-types_js.html#lineno17">queue-access-types.js</a> at line 17
-->
  </div>
...
<div class="description "><p><p>An exclusive endpoint. The first client to bind
receives the stored messages on the Endpoint.</p></p></div>
...
<h3 id="NONEXCLUSIVE" class="public">
  
  <div class="location">
<!--
  	<a href="_opt_cvsdirs_loadbuild_jenkins_slave_apps-linux26-64-2_workspace_solclientjs_release_npm_org_solclientjs_sdk_core_node_modules_solclient-queue_lib_queue-access-types_js.html#lineno23">queue-access-types.js</a> at line 23
-->
  </div>
...
<div class="description "><p><p>A non-exclusive (shared) Queue. Each client to bind
receives messages in a round robin fashion.</p></p></div>
