...
<small><sub>Version: 10.0.0 </sub></small>
				...
				<h1>
					<a href="solace.html" ><abbr title="solace">solace</abbr></a>.MessagePublisherAcknowledgeMode
				</h1>
			</div>
		</header>
	...
	<ul>
		...
		<li><a href="#static_properties">Static Properties & Enumerations</a></li>
			...
			<div class="description "><p><p>Represents authentication scheme enumeration.</p></p></div>
  ...
  <tbody>
    ...
    <tr class="public">
      ...
      <td class="last">
        <a href="#PER_MESSAGE">
        	<abbr title="solace.MessagePublisherAcknowledgeMode.PER_MESSAGE">
        		PER_MESSAGE
        	</abbr>
        </a>
        
        <span class="value">
         = <code>PER_MESSAGE</code>
        </span>
    ...
    <tr class="public">
      ...
      <td class="last">
        <a href="#WINDOWED">
        	<abbr title="solace.MessagePublisherAcknowledgeMode.WINDOWED">
        		WINDOWED
        	</abbr>
        </a>
      ...
      <td>
			...
			<h3 id="PER_MESSAGE" class="public">
  
  <div class="location">
<!--
  	<a href="_opt_cvsdirs_loadbuild_jenkins_slave_apps-linux26-64-2_workspace_solclientjs_release_npm_org_solclientjs_sdk_core_node_modules_solclient-message-publisher_lib_message-publisher-acknowledge-modes_js.html#lineno15">message-publisher-acknowledge-modes.js</a> at line 15
-->
  </div>
...
<div class="description "><p><p>Applications receive an acknowledgement for every
message.</p></p></div>
...
<h3 id="WINDOWED" class="public">
  
  <div class="location">
<!--
  	<a href="_opt_cvsdirs_loadbuild_jenkins_slave_apps-linux26-64-2_workspace_solclientjs_release_npm_org_solclientjs_sdk_core_node_modules_solclient-message-publisher_lib_message-publisher-acknowledge-modes_js.html#lineno21">message-publisher-acknowledge-modes.js</a> at line 21
-->
  </div>
...
<div class="description "><p><p>Applications receive a windowed acknowledgement that
acknowledges the returned correlation identifier and every message sent prior.</p></p></div>
