...
<small><sub>Version: 10.0.0 </sub></small>
		...
		<div class="content">
			...
			<h1>Solace Node.js Messaging API</h1><p><em>Copyright 2011-2018 Solace Corporation. All rights reserved.</em></p>
...
<h2>INTRODUCTION</h2><p>This is the Solace Node.js Messaging API. This API allows Node.js applications
to send messages to, and receive messages from, a Solace Messaging Router.</p>
<h2>SUPPORTED PLATFORMS</h2><p>Solclientjs is supported in LTS versions of Node.js which are either active
or in maintenance.</p>
...
<a href="https://solacesamples.github.io/solace-samples-nodejs">Solace Samples: Node.js</a></p>
...
OR  var solace = require('solclientjs').debug;      // loads debug</code></pre><h2>API PROFILES</h2><p>The API has the concept of an initialization profile. The intent of the
...
<pre class="prettyprint source"><code>var solace = require('solclientjs').debug;
...
solace.SolclientFactory.setLogLevel(solace.LogLevel.TRACE);</code></pre>
