...
<small><sub>Version: 10.0.0 </sub></small>
				...
				<h1>
					<a href="solace.html" ><abbr title="solace">solace</abbr></a>.MessageDumpFlag
				</h1>
			</div>
		</header>
	...
	<ul>
		...
		<li><a href="#static_properties">Static Properties & Enumerations</a></li>
			...
			<div class="description "><p><p>Represents an enumeration of message dump formats. It controls
the output of <a href="solace.Message.html#dump">solace.Message#dump</a>.</p></p></div>
  ...
  <tbody>
    ...
    <tr class="public">
      ...
      <td class="last">
        <a href="#MSGDUMP_BRIEF">
        	<abbr title="solace.MessageDumpFlag.MSGDUMP_BRIEF">
        		MSGDUMP_BRIEF
        	</abbr>
        </a>
    ...
    <tr class="public">
      ...
      <td class="last">
        <a href="#MSGDUMP_FULL">
        	<abbr title="solace.MessageDumpFlag.MSGDUMP_FULL">
        		MSGDUMP_FULL
        	</abbr>
        </a>
      ...
      <td>
			...
			<h3 id="MSGDUMP_BRIEF" class="public">
  
  <div class="location">
<!--
  	<a href="_opt_cvsdirs_loadbuild_jenkins_slave_apps-linux26-64-2_workspace_solclientjs_release_npm_org_solclientjs_sdk_core_node_modules_solclient-message_lib_message-dump-flags_js.html#lineno15">message-dump-flags.js</a> at line 15
-->
  </div>
...
<div class="description "><p><p>Display only the length of the binary attachment, XML content and user property maps.</p></p></div>
...
<h3 id="MSGDUMP_FULL" class="public">
  
  <div class="location">
<!--
  	<a href="_opt_cvsdirs_loadbuild_jenkins_slave_apps-linux26-64-2_workspace_solclientjs_release_npm_org_solclientjs_sdk_core_node_modules_solclient-message_lib_message-dump-flags_js.html#lineno19">message-dump-flags.js</a> at line 19
-->
  </div>
...
<div class="description "><p><p>Display the entire message contents.</p></p></div>
