...
<small><sub>Version: 10.0.0 </sub></small>
				...
				<h1>
					<a href="solace.html" ><abbr title="solace">solace</abbr></a>.DestinationType
				</h1>
			</div>
		</header>
	...
	<ul>
		...
		<li><a href="#static_properties">Static Properties & Enumerations</a></li>
			...
			<div class="description "><p><p>Enumerates destination types for destination objects.</p></p></div>
  ...
  <tbody>
    ...
    <tr class="public">
      ...
      <td class="last">
        <a href="#QUEUE">
        	<abbr title="solace.DestinationType.QUEUE">
        		QUEUE
        	</abbr>
        </a>
    ...
    <tr class="public">
      ...
      <td class="last">
        <a href="#TEMPORARY_QUEUE">
        	<abbr title="solace.DestinationType.TEMPORARY_QUEUE">
        		TEMPORARY_QUEUE
        	</abbr>
        </a>
        
        <span class="value">
         = <code>temporary_queue</code>
        </span>
    ...
    <tr class="public">
      ...
      <td class="last">
        <a href="#TOPIC">
        	<abbr title="solace.DestinationType.TOPIC">
        		TOPIC
        	</abbr>
        </a>
  ...
  <div class="location">
<!--
  	<a href="_opt_cvsdirs_loadbuild_jenkins_slave_apps-linux26-64-2_workspace_solclientjs_release_npm_org_solclientjs_sdk_core_node_modules_solclient-destination_lib_destination-type_js.html#lineno18">destination-type.js</a> at line 18
-->
  </div>
...
<div class="description "><p><p>A queue destination.</p></p></div>
...
<h3 id="TEMPORARY_QUEUE" class="public">
  
  <div class="location">
<!--
  	<a href="_opt_cvsdirs_loadbuild_jenkins_slave_apps-linux26-64-2_workspace_solclientjs_release_npm_org_solclientjs_sdk_core_node_modules_solclient-destination_lib_destination-type_js.html#lineno22">destination-type.js</a> at line 22
-->
  </div>
...
<div class="description "><p><p>A temporary queue destination.</p></p></div>
...
<h3 id="TOPIC" class="public">
  ...
  <div class="location">
<!--
  	<a href="_opt_cvsdirs_loadbuild_jenkins_slave_apps-linux26-64-2_workspace_solclientjs_release_npm_org_solclientjs_sdk_core_node_modules_solclient-destination_lib_destination-type_js.html#lineno14">destination-type.js</a> at line 14
-->
  </div>
...
<div class="description "><p><p>A Topic destination.</p></p></div>
