...
<small><sub>Version: 10.0.0 </sub></small>
				...
				<h1>
					<a href="solace.html" ><abbr title="solace">solace</abbr></a>.RequestEventCode
				</h1>
			</div>
		</header>
	...
	<ul>
		...
		<li><a href="#static_properties">Static Properties & Enumerations</a></li>
			...
			<div class="description "><p><p>An attribute of <a href="solace.RequestError.html">solace.RequestError</a>. This enumeration represents the
...
of a communication error.</p></p></div>
    ...
    <tr class="public">
      ...
      <td class="last">
        <a href="#REQUEST_ABORTED">
        	<abbr title="solace.RequestEventCode.REQUEST_ABORTED">
        		REQUEST_ABORTED
        	</abbr>
        </a>
    ...
    <tr class="public">
      ...
      <td class="last">
        <a href="#REQUEST_TIMEOUT">
        	<abbr title="solace.RequestEventCode.REQUEST_TIMEOUT">
        		REQUEST_TIMEOUT
        	</abbr>
        </a>
  ...
  <div class="location">
<!--
  	<a href="_opt_cvsdirs_loadbuild_jenkins_slave_apps-linux26-64-2_workspace_solclientjs_release_npm_org_solclientjs_sdk_core_node_modules_solclient-error_lib_request-event-codes_js.html#lineno21">request-event-codes.js</a> at line 21
-->
  </div>
...
<div class="description "><p><p>A request was aborted because the session is disconnected.</p></p></div>
...
<h3 id="REQUEST_TIMEOUT" class="public">
  ...
  <div class="location">
<!--
  	<a href="_opt_cvsdirs_loadbuild_jenkins_slave_apps-linux26-64-2_workspace_solclientjs_release_npm_org_solclientjs_sdk_core_node_modules_solclient-error_lib_request-event-codes_js.html#lineno25">request-event-codes.js</a> at line 25
-->
  </div>
...
<div class="description "><p><p>The event represents a timed-out request API call.</p></p></div>
