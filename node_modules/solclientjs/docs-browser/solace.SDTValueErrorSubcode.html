...
<small><sub>Version: 10.0.0 </sub></small>
				...
				<h1>
					<a href="solace.html" ><abbr title="solace">solace</abbr></a>.SDTValueErrorSubcode
				</h1>
			</div>
		</header>
	...
	<ul>
		...
		<li><a href="#static_properties">Static Properties & Enumerations</a></li>
			...
			<div class="description "><p><p>Enumeration of solace.SDTUnsuportedValueError causes.</p></p></div>
  ...
  <tbody>
    ...
    <tr class="public">
      ...
      <td class="last">
        <a href="#VALUE_OUTSIDE_SUPPORTED_RANGE">
        	<abbr title="solace.SDTValueErrorSubcode.VALUE_OUTSIDE_SUPPORTED_RANGE">
        		VALUE_OUTSIDE_SUPPORTED_RANGE
        	</abbr>
        </a>
      ...
      <td>
			...
			<h3 id="VALUE_OUTSIDE_SUPPORTED_RANGE" class="public">
  
  <div class="location">
<!--
  	<a href="_opt_cvsdirs_loadbuild_jenkins_slave_apps-linux26-64-2_workspace_solclientjs_release_npm_org_solclientjs_sdk_core_node_modules_solclient-sdt_lib_sdt-value-error-subcodes_js.html#lineno16">sdt-value-error-subcodes.js</a> at line 16
-->
  </div>
    ...
    <span class="returnvalues">
      Number
		...
		<strong>VALUE_OUTSIDE_SUPPORTED_RANGE</strong>
...
<div class="description "><p><p>The value for this field may be valid on other platforms, but is outside the
range that is supported on this platform for the given type.</p></p></div>
